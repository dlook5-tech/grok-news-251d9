...
prompt_for() {
    local tab=$1
    case "$tab" in
        world)    echo "Top highest-view WORLD news EVENTS on X in the past 24h (international, outside the US)." ;;
        usa)      echo "Top highest-view US NATIONAL news EVENTS on X in the past 24h (politics, federal events)." ;;
